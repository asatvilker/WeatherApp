    ...
    render() {
        return (
            <>
                ...
                <Dropdown data={this.props.data.hourly} celsius={this.props.data.celsius} wind={this.props.data.kmh} open={this.state.open} toggleCollapse={this.toggleCollapse}/> {/* passing hourly info to dropdown for hourly forecast*/}
