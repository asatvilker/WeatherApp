            ...
            <div id="dropdown">
                <MDBRow>
                    <MDBCollapse id="basicCollapse" isOpen={this.props.open} style={{marginBottom:"5vh", width:"100%"}}> {/*the bootstrap dropdown component, passes through the state value which indicates to the component whether to open drop down or not */}
                        <Hourly data={this.props.data} fahrenheit={this.props.fahrenheit} wind={this.props.wind}/> {/* within the dropdown, we have the hourly component, shows data for next few hours, we pass through the data as props */}
                    </MDBCollapse>
