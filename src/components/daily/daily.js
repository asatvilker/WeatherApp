        ...
        return (
            <div id="daily">
                ...
                <MDBContainer className="d-flex flex-row hourlyContainer" style={{ margin: "0 0" }}> {/*bootsrap classes to make display felex and as a row */}
                    {
                        this.props.data.slice(1,7).map(data => { /* loops through each element (each day) */
                            ...
                            return (
                                <Card time={day} temp={temp} icon={data.weatherIcon} condition={data.weatherDesc} fahrenheit={this.props.fahrenheit} wind={data.wind} kmh={this.props.kmh}/>
